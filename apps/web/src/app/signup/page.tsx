...
import { LayoutGrid, Loader2, Lock, Mail, ShieldAlert, User } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-8 z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Start tracking website visitors with full privacy isolation
          </p>
        </div>
        ...
        <div className="bg-neutral-900/60 border border-neutral-800/80 backdrop-blur-xl rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-neutral-400">
              ...
              <Link href="/login" className="font-semibold text-primary hover:text-primary/90 transition duration-150">
                Sign in instead
              </Link>
            </p>
          </div>
